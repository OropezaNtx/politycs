...
export async function getAnalyticsSummary(source = "all") {
  const response = await api.get(`/analytics/summary?source=${source}`);
  return response.data;
}

export async function getSentimentAnalytics(source = "all") {
  const response = await api.get(`/analytics/sentiment?source=${source}`);
  return response.data;
}

export async function getTopicsAnalytics(source = "all") {
  const response = await api.get(`/analytics/topics?source=${source}`);
  return response.data;
}

export async function getTrendsAnalytics(source = "all") {
  const response = await api.get(`/analytics/trends?source=${source}`);
  return response.data;
}

export async function getTimelineAnalytics(source = "all") {
  return getTrendsAnalytics(source);
}

export async function getTopPoliticalPosts(source = "all") {
  const response = await api.get(`/analytics/top-political?limit=10&source=${source}`);
  return response.data;
}
...
export async function getTemporalIntelligence(options = {}) {
  const response = await api.get("/intelligence/v2/temporal", {
    params: intelligenceParams(options),
  });
  return response.data;
}

export async function getCrisisIntelligenceV2(options = {}) {
  const response = await api.get("/intelligence/v2/crisis", {
    params: intelligenceParams(options),
  });
  return response.data;
}

export async function getGeoIntelligenceV2({
  source = "all",
  projectId = null,
  windowHours = 168,
} = {}) {
...
export async function getIntelligenceBrief(options = {}) {
  const response = await api.get("/intelligence/v2/brief", {
    params: intelligenceParams(options),
  });
  return response.data;
}

export async function getIntelligenceEvidence({
  source = "all",
  projectId = null,
  topic = null,
  territory = null,
...
export async function createMonitoringProject(payload) {
  const response = await api.post("/projects", payload);
  return response.data;
}

export async function updateMonitoringProject(projectId, payload) {
  const response = await api.put(`/projects/${projectId}`, payload);
  return response.data;
}

export async function deleteMonitoringProject(projectId) {
